...
frappe.ui.form.on("Purchase Order", {
    ...
    branch: function (frm) {
        if (_purchaseOrderCommissionDefaults.branch && frm.doc.branch !== _purchaseOrderCommissionDefaults.branch) {
            frm.set_value("branch", _purchaseOrderCommissionDefaults.branch);
        }
    },
    cost_center: function (frm) {
        if (_purchaseOrderCommissionDefaults.cost_center && frm.doc.cost_center !== _purchaseOrderCommissionDefaults.cost_center) {
