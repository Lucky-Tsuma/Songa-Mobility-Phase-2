...
frappe.ui.form.on("Purchase Invoice", {
	...
	branch: function (frm) {
		if (
			_purchaseInvoiceCommissionDefaults.branch &&
			frm.doc.branch !== _purchaseInvoiceCommissionDefaults.branch
		) {
	...
	cost_center: function (frm) {
		if (
			_purchaseInvoiceCommissionDefaults.cost_center &&
			frm.doc.cost_center !== _purchaseInvoiceCommissionDefaults.cost_center
		) {
