...
frappe.ui.form.on("Sales Invoice", {
	...
	branch: function (frm) {
		if (
			_salesInvoicecommissionDefaults.branch &&
			frm.doc.branch !== _salesInvoicecommissionDefaults.branch
		) {
	...
	cost_center: function (frm) {
		if (
			_salesInvoicecommissionDefaults.cost_center &&
			frm.doc.cost_center !== _salesInvoicecommissionDefaults.cost_center
		) {
