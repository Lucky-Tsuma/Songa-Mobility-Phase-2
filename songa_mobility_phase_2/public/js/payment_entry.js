...
frappe.ui.form.on("Payment Entry", {
	...
	branch: function (frm) {
		if (
			_paymentEntrycommissionDefaults.branch &&
			frm.doc.branch !== _paymentEntrycommissionDefaults.branch
		) {
	...
	cost_center: function (frm) {
		if (
			_paymentEntrycommissionDefaults.cost_center &&
			frm.doc.cost_center !== _paymentEntrycommissionDefaults.cost_center
		) {
